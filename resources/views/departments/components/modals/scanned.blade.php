                    ...
                    <div class="modal-body">
                        ...
                        <div class="row g-3">
                            ...
                            <div class="col-8 text-center" style="margin: auto;">
                                ...
                                <input class="form-control text-center" type="text" name="tracking_no" placeholder="TRK-XXXXXX" required>
                            </div>
                            ...
                            <div class="col-8 text-center mt-3" style="margin: auto;">
                                ...
                                <input class="btn btn-success text-center" type="button" value="Scanner" data-bs-toggle="tooltip" data-bs-placement="top" title="Scanner Received">
                            </div>
                        </div>
                    </div>
                </div><!-- /.modal-content -->
